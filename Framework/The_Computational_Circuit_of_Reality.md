...
***Speed of Light as Clock Speed, Golden Ratio as Compression Algorithm,***

***and the Substance–Motion Gradient***
...
The Planck time t\_P ≈ 5.39 × 10⁻⁴⁴ s is the smallest meaningful time interval, defined as t\_P = l\_P / c \[11\]. In natural units, c = 1 Planck length per Planck time: one computational step per tick.
...
\[12\] Ge, M. (2025). Holographic Discrete Unified Cosmology: An Emergent Spacetime Model Based on Minimal Geometric Units and Thermodynamic Drives. PhilArchive. [https://philarchive.org/archive/GEHDUU](https://philarchive.org/archive/GEHDUU)
